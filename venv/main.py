def calculadora_notas():
    print("Seja bem-vindo à Calculadora de Nota da UFSC BY da cabeça da minha namorada kkkkk")

    # Inicializando as variáveis
    nota_prova = 0
    porcentagem_prova = 0
    nota_trabalho = 0
    porcentagem_trabalho = 0

    # Nota da prova
    while nota_prova == 0 or porcentagem_prova == 0 or nota_trabalho == 0 or porcentagem_trabalho == 0:
        try:
            ...
            porcentagem_trabalho = float(input("Digite o modelo de porcentagem dos trabalho *SOMENTE O NUMERO* SEM A (%): "))
